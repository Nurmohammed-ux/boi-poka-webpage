...
const Navbar = () => {
  const links = (
    <>
      <li>
        <a className="hover:border ease-in-out hover:border-[#23BE0A] hover:bg-white hover:text-[#23BE0A] text-lg font-medium">
          Home
        </a>
      </li>
      <li>
  ...
  return (
    <div className="navbar bg-base-100 py-10 px-0">
